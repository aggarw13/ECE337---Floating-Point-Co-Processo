...
COMPONENT_FILES	:= flex_fifo.sv flex_indexer.sv scheduling_logic.sv dependancy_reg.sv instruction_parser.sv decode.sv decodeLayer.sv encode.sv encodeLayer.sv DataSelMux.sv regMuxLayer.sv registerFile.sv outSel.sv StateMemory.sv dependency_remove.sv
