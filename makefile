...
COMPONENT_FILES	:= apb_clk_detect.sv upDownCounter.sv flex_fifo.sv flex_indexer.sv scheduling_logic.sv dependancy_reg.sv instruction_parser.sv decode.sv decodeLayer.sv encode.sv encodeLayer.sv DataSelMux.sv regMuxLayer.sv registerFile.sv outSel.sv dependency_remove.sv 
...
COMPONENT_FILES += scheduler.sv add_block.sv APB_slave_interface.sv StateMemory.sv subtract_block.sv multiply.sv sine.sv absolution.sv negation.sv load_block.sv store.sv
